 ...
 */
@ApiModel(description = "Mapping of label to predicted probability")
public class PValueMapping {
	...
	@ApiModelProperty(required = true, value = "probability", example="0.75")
	@NotNull
	...
	public String toString() {
		...
		jsonResponse.put("probability", pValue);
