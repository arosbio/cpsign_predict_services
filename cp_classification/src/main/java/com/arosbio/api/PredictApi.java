...
public class PredictApi  {
	...
	@Operation(
			...
			responses = { 
					@ApiResponse(responseCode = "200", description = "OK", content = @Content(
							schema = @Schema(implementation = ClassificationResult.class))),
	...
	@Operation(
			summary = "Make a prediction on a given molecule", 
			tags = { PREDICT_TAG },
			description = "Predict a molecule in SMILES or MDL v2000/v3000 format",
			responses = { 
					@ApiResponse(responseCode = "200", description = "OK", content = @Content(
							schema = @Schema(implementation = ClassificationResult.class))),
